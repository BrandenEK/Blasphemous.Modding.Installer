...
internal class NewValidator : IValidator
{
    private readonly string _defaultPath;
    private readonly string _exeName;
    private readonly string _localVersionPath = ".modtools_version";
    ...
    public NewValidator(string defaultPath, string exeName, string remoteDownloadPath, string remoteVersionPath, IIconLoader iconLoader, GameSettings settings)
    {
    ...
    public bool AreModdingToolsUpdated
    {
        ...
        {
            string path = Path.Combine(_settings.RootFolder, _localVersionPath);
            var localVersion = new Version(File.ReadAllText(path));
